...
usado por el equipo que organiza el alojamiento de un evento masivo de la iglesia.
...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Obtiene los totales del evento activo: hogares registrados, capacidad total, ocupación actual y lugares disponibles.',
